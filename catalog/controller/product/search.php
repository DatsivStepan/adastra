...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/search.tpl')) {
			$this->response->setOutput(magicslideshow($this->load->view($this->config->get('config_template') . '/template/product/search.tpl', $data),$this,'search',(isset($results) ? $results : array())));
		} else {
			$this->response->setOutput(magicslideshow($this->load->view('default/template/product/search.tpl', $data),$this,'search',(isset($results) ? $results : array())));
		}
	}
}
