...
function ready() {
    ...
    wSlider.noUiSlider.on('slide', function(){
        ...
        setSliderLabels(width, height);
        cropper.setCropBoxData({"left":(cropperSize.left+difWidth/2),"top":cropperSize.top,"width":width,"height":cropperSize.height});
    });
    ...
    hSlider.noUiSlider.on('slide', function(){
        ...
        setSliderLabels(width, height);
        cropper.setCropBoxData({"left":cropperSize.left,"top":(cropperSize.top+difHeight/2),"width":cropperSize.width,"height":height});
    });
    ...
    var setFrame = function() {
        ...
        //n
        document.styleSheets[0].addRule('#frame .n:before','background: url("'+serverName+frameName_line+'"); height:'+(wSliderMaxValue-42)+'px; left: '+((wSliderMaxValue-32)/2+20)+'px; top:'+((((wSliderMaxValue-32)/2+20)-50)*(-1))+'px;');
        document.styleSheets[0].insertRule('#frame .n:before { background: url("'+serverName+frameName_line+'"); height:'+(wSliderMaxValue-42)+'px; left: '+((wSliderMaxValue-32)/2+20)+'px; top:'+((((wSliderMaxValue-32)/2+20)-50)*(-1))+'px;}', 0);

        //ne
        document.styleSheets[0].addRule('#frame .ne','background: url("'+serverName+frameName_corner+'"); left:'+(wSliderMaxValue+8)+'px;');
        document.styleSheets[0].insertRule('#frame .ne { background: url("'+serverName+frameName_corner+'"); left:'+(wSliderMaxValue+8)+'px; }', 0);

        //e
        document.styleSheets[0].addRule('#frame .e','background: url("'+serverName+frameName_line+'"); height: '+(hSliderMaxValue-40)+'px; left:'+(wSliderMaxValue+8)+'px;');
        document.styleSheets[0].insertRule('#frame .e { background: url("'+serverName+frameName_line+'"); height: '+(hSliderMaxValue-40)+'px; left:'+(wSliderMaxValue+8)+'px; }', 0);

        //se
        document.styleSheets[0].addRule('#frame .se','background: url("'+serverName+frameName_corner+'"); left:'+(wSliderMaxValue+8)+'px; top:'+(hSliderMaxValue+8)+'px;');
        document.styleSheets[0].insertRule('#frame .se { background: url("'+serverName+frameName_corner+'"); left:'+(wSliderMaxValue+8)+'px; top:'+(hSliderMaxValue+8)+'px; }', 0);

        //s
        document.styleSheets[0].addRule('#frame .s:before','background: url("'+serverName+frameName_line+'"); height:'+(wSliderMaxValue-42)+'px; left: '+((wSliderMaxValue-32)/2+20)+'px; top:'+((((wSliderMaxValue-32)/2+20)-50)*(-1)-2)+'px;');
        document.styleSheets[0].insertRule('#frame .s:before { background: url("'+serverName+frameName_line+'"); height:'+(wSliderMaxValue-42)+'px; left: '+((wSliderMaxValue-32)/2+20)+'px; top:'+((((wSliderMaxValue-32)/2+20)-50)*(-1)-2)+'px;}', 0);

        //sw
        document.styleSheets[0].addRule('#frame .sw','background: url("'+serverName+frameName_corner+'"); top:'+(hSliderMaxValue+8)+'px; ');
        document.styleSheets[0].insertRule('#frame .sw { background: url("'+serverName+frameName_corner+'"); top:'+(hSliderMaxValue+8)+'px;  }', 0);

        //w
        document.styleSheets[0].addRule('#frame .w','background: url("'+serverName+frameName_line+'"); height: '+(hSliderMaxValue-40)+'px;');
        document.styleSheets[0].insertRule('#frame .w { background: url("'+serverName+frameName_line+'"); height: '+(hSliderMaxValue-40)+'px; }', 0);
