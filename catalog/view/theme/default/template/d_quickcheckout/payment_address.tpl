...
<div class="<%= parseInt(model.config.display) ? '' : 'hidden' %>">
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 panel panel-default" style="padding: 0;border: none;background-color: #ffffff!important;box-shadow: none;">
			<div class="panel-body">
					<h4 class="panel-title" style="margin-bottom: 15px; text-align: center;">
						<span class="text text_dost2"><%= model.config.title %></span>
					</h4>
				</div>
