      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-lg-6"><a href="museums" class="btnLink">Назад в каталог</a></div>
            </div>
          </div>
        </div>
        <div class="row museum-ing-bottom">
          ...
          <div class="row no-margin">
            ...
            <a href="<?= $product['href']; ?>&museum_id=<?= $_GET['manufacturer_id'] ?>" class="artists-product-text-style">
              <div class="col-lg-2">
