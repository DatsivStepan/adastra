            ...
            <div class="KP">
                ...
                <div class="KP_25">
                    <div class="product-thumb_style">
                        <div class="image hidden-xs"><a class="imga_catalog" href="<?php echo $product['href']; ?>" style="background: url('<?php echo $product['thumb']; ?>') center no-repeat; min-height: 300px; background-size:contain; min-width: 219px;"></a>
                        </div>
                        <div>
            ...
            <div class="row hidden-sm hidden-md hidden-lg">
                ...
                <div class="img" style="position: relative; margin-bottom: 8%;margin-top: 8%;">
                    ...
                    <div class="conteiner_proz_3 hidden-sm hidden-md hidden-lg" style="margin-bottom: 55px;">
                        ...
                        <div class="pull-right_KP_2-1 pull-right_KP_20-1"
