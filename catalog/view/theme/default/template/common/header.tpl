            ...
            <div class="container hidden-xs">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4  no-padding">
                                        <i>
                                            <img class="header-phone-icon-width"
                    ...
                    <?php echo $telephone2; ?>
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 no-padding">
                                        <i>
                                            <img class="header-email-icon-width"
                                ...
                                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 no-padding" style="margin-top: 15px">
                                    <div class="row">
                                        <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                            <div id="products"
                                                 class="products-style fa fa-bars  no-padding div-products-style">
                                            <span class="title header-text-style"
                                                  style="padding-left: 5px">ПРОДУКЦИЯ <span id="product_1"
                                                                                            class="fa fa-angle-down product-icon-size"></span></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6" style="margin-top: -10px">
                                            ...
                                            <span class="header-contact-text-style-1" data-toggle="modal"
                                                  data-target="#contactForm_ru">Обратный звонок</span></br>
                                                <span class="header-contact-text-style-2" data-toggle="modal"
                                                      data-target="#contactForm_en">We speak english</span>
                                            </div>
                                        </div>
