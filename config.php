<?php
// HTTP
define('HTTP_SERVER', 'http://adastra.local/');

// HTTPS
define('HTTPS_SERVER', 'http://adastra.local/');

// DIR
define('DIR_APPLICATION', 'C:/Server/OpenServer/domains/adastra.local/catalog/');
define('DIR_SYSTEM', 'C:/Server/OpenServer/domains/adastra.local/system/');
define('DIR_LANGUAGE', 'C:/Server/OpenServer/domains/adastra.local/catalog/language/');
define('DIR_TEMPLATE', 'C:/Server/OpenServer/domains/adastra.local/catalog/view/theme/');
