  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-materialsAndPrices" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-materialsAndPrices" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <!------------------------------------------------------------------------->
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="<?php echo $help_fabric_thickness; ?>"><?php echo $entry_fabric_thickness; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="fabric_thickness" value="<?php echo $fabric_thickness; ?>" placeholder="<?php echo $entry_fabric_thickness; ?>" id="input-fabric_thickness" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="<?php echo $help_MPWJ; ?>"><?php echo $entry_MPWJ; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="MPWJ" value="<?php echo $MPWJ; ?>" placeholder="<?php echo $entry_MPWJ; ?>" id="input-MPWJ" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="<?php echo $help_prices; ?>"><?php echo $entry_prices; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="prices" value="<?php echo $prices; ?>" placeholder="<?php echo $entry_prices; ?>" id="input-prices" class="form-control" />
                </div>
              </div>
              <!------------------------------------------------------------------------->
              <div class="form-group">
                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left"><select name="materialsAndPrices_layout[0]" class="form-control">
                          <option value=""></option>
                          <?php foreach ($layouts as $layout) { ?>
                          <?php if (isset($materialsAndPrices_layout[0]) && $materialsAndPrices_layout[0] == $layout['layout_id']) { ?>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><select name="materialsAndPrices_layout[<?php echo $store['store_id']; ?>]" class="form-control">
                          <option value=""></option>
                          <?php foreach ($layouts as $layout) { ?>
                          <?php if (isset($materialsAndPrices_layout[$store['store_id']]) && $materialsAndPrices_layout[$store['store_id']] == $layout['layout_id']) { ?>
                          <option value="<?php echo $layout['layout_id']; ?>" selected="selected"><?php echo $layout['name']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $layout['layout_id']; ?>"><?php echo $layout['name']; ?></option>
                          <?php } ?>
